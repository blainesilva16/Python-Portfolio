...
const TodoListDemo = () => {
  ...
  const ListsPanel = ({ isSidebar = false }: { isSidebar?: boolean }) => (
    ...
    <div className="todo-demo-container">
      ...
      <div className="todo-main">
        ...
        <div className="todo-divider">
          {/* Lists panel - desktop */}
          <div className="todo-lists-container todo-input-container">
            <ListsPanel />
          </div>

          {/* Tasks panel */}
          <div className="todo-tasks-container todo-input-container">
            <div className="todo-tasks-inner">
              <h3 className="todo-list-name">
